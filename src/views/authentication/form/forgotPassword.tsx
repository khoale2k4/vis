...
export function ResetForm({ setView }: AuthenticationFormProps) {
	...
	return (
		<div className="animate-appear_right_smooth w-full text-black">
			<form
				...
				<span className="text-2xl font-semibold text-center mb-4 -mt-12">
				...
				<div className="w-full flex gap-3">
					<div
						...
						className="border-2 border-darkblue-500 duration-150
						text-darkblue-500 text-3xl aspect-square h-12 rounded-lg grid place-items-center"
					>
			...
			>
				<span className="mb-4 -mt-12 text-2xl font-semibold text-center">
					Verify Otp
				</span>
			...
			<form
				...
				className={`gap-5 text-black flex flex-col items-center top-0 left-0 z-20 h-full w-full
				${showSecondForm ? "animate-appear_right_smooth" : "hidden"} text-black flex flex-col items-center gap-5`}>
