...
export default function HeroSection() {
  return (
    <div className="flex flex-col items-center justify-center w-full h-fit">
      <div className="w-full mt-20 -mb-1 h-96 bg-darkblue-500" />
      <Image
        src={Background}
        alt="Background"
        placeholder="empty"
      ...
      <div className="absolute top-0 z-10 flex items-center justify-center h-full gap-10 px-8 w-fit md:px-16 lg:px-28 xl:px-32">
        <div className="flex flex-col w-full xl:w-1/2 h-fit">
          <h1 className="text-2xl font-bold text-white xl:text-3xl">
            Best solution for clould storage
          </h1>
          <span className="text-white text-md">
            Lorem ipsum odor amet, consectetuer adipiscing elit. Dignissim
            hendrerit vel magnis turpis tellus sit
          </span>
          <div className="flex items-center w-full gap-4 mt-10 h-fit">
            <Link
              href="#"
              className="px-6 py-2 text-white rounded-full bg-orangelogo-500">
              Start now for free
            </Link>
