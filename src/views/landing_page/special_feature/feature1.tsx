    ...
    return (
        <div className="flex flex-col-reverse items-start w-full gap-20 px-8 lg:flex-row h-fit md:px-16 lg:px-28 xl:px-32">
            ...
            <div className="flex flex-col w-full gap-4 lg:w-1/2">
                <h1 className="text-2xl font-bold lg:text-3xl">Special Feature 1</h1>
                <span className="font-medium text-md lg:text-lg text-justify pr-1">
                ...
                <div className="flex justify-end w-full">
                    <Link href={"#"} className="font-semibold text-darkblue-500 hover:underline hover:underline-offset-4 flex gap-1 place-items-center">
                        Learn more about this feature <FaChevronRight className="h-3.5 mt-0.5" />
                    </Link>
                </div>
            </div>
        </div>
