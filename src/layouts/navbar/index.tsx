...
export default function Navbar() {
  return (
    <div className="fixed top-0 left-0 z-50 flex items-center w-full gap-12 px-12 py-4 bg-darkblue-500 sm-max:px-4 sm-max:py-4">
      ...
      <div className="flex items-center justify-center gap-4 ml-auto w-fit h-fit ">
        <NavbarButton
          name="Sign in"
          link="#"
          className="text-white bg-darkblue-500 hover:bg-darkblue-600"
        />
        <NavbarButton
          name="Sign up"
          link="#"
          className="bg-white text-darkblue-500 hover:bg-white-300"
        />
      </div>
    </div>
  );
