...
export default function Footer() {
    return (
        <div className="flex flex-col items-center justify-between min-w-full px-8 py-10 text-white gap-x-48 gap-y-20 2xl:flex-row md:px-16 lg:px-28 bg-darkblue-900">
            ...
            <div className="flex flex-col place-items-center justify-center h-full w-full gap-4">
                ...
                <span className="flex flex-col items-center justify-center text-sm">
                    <span>Copyright ©2024 VietNam Innovation Solution.</span>
